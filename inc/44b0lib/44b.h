...
#define rWATCON			(*(volatile unsigned short *)0X01D30000)	
#define rWATDAT			(*(volatile unsigned short *)0X01D30004)	
#define rWATCNT			(*(volatile unsigned short *)0X01D30008)

#define BIT_WDT_ENABLE			(0x01<<5)
#define BIT_WDT_INT_ENABLE		(0x01<<2)
#define BIT_WDT_RST_ENABLE		(0x01<<0)	

#define BIT_WDT_CLK_SEL			(0X3    <<3)		/* 1/128 */
#define BIT_WDT_PRE_SCALER		(0XFF   <<8)		/* 255   */
...
#define  HandleReset    ( _ISR_STARTADDRESS)
#define  HandleUndef    ( _ISR_STARTADDRESS + 0x04)
#define  HandleSWI      ( _ISR_STARTADDRESS + 0x08)
#define  HandlePabort   ( _ISR_STARTADDRESS + 0x0c)
#define  HandleDabort   ( _ISR_STARTADDRESS + 0x10)
#define  HandleReserved ( _ISR_STARTADDRESS + 0x14)
#define  HandleIRQ      ( _ISR_STARTADDRESS + 0x18)
#define  HandleFIQ      ( _ISR_STARTADDRESS + 0x1c)
#define  HandleADC      ( _ISR_STARTADDRESS + 0x20)
#define  HandleRTC      ( _ISR_STARTADDRESS + 0x24)
#define  HandleUTXD1    ( _ISR_STARTADDRESS + 0x28)
#define  HandleUTXD0    ( _ISR_STARTADDRESS + 0x2c)
#define  HandleSIO      ( _ISR_STARTADDRESS + 0x30)
#define  HandleIIC      ( _ISR_STARTADDRESS + 0x34)
#define  HandleURXD1    ( _ISR_STARTADDRESS + 0x38)
#define  HandleURXD0    ( _ISR_STARTADDRESS + 0x3c)
#define  HandleTIMER5   ( _ISR_STARTADDRESS + 0x40)
#define  HandleTIMER4   ( _ISR_STARTADDRESS + 0x44)
#define  HandleTIMER3   ( _ISR_STARTADDRESS + 0x48)
#define  HandleTIMER2   ( _ISR_STARTADDRESS + 0x4c)
#define  HandleTIMER1   ( _ISR_STARTADDRESS + 0x50)
#define  HandleTIMER0   ( _ISR_STARTADDRESS + 0x54)
#define  HandleUERR01   ( _ISR_STARTADDRESS + 0x58)
#define  HandleWDT      ( _ISR_STARTADDRESS + 0x5c)
#define  HandleBDMA1    ( _ISR_STARTADDRESS + 0x60)
#define  HandleBDMA0    ( _ISR_STARTADDRESS + 0x64)
#define  HandleZDMA1    ( _ISR_STARTADDRESS + 0x68)
#define  HandleZDMA0    ( _ISR_STARTADDRESS + 0x6c)
#define  HandleTICK     ( _ISR_STARTADDRESS + 0x70)
#define  HandleEINT4567 ( _ISR_STARTADDRESS + 0x74)
#define  HandleEINT3    ( _ISR_STARTADDRESS + 0x78)
#define  HandleEINT2    ( _ISR_STARTADDRESS + 0x7c)
#define  HandleEINT1    ( _ISR_STARTADDRESS + 0x80)
#define  HandleEINT0    ( _ISR_STARTADDRESS + 0x84)
